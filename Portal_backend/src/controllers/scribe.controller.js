...
export const acceptExamRequest = async (req, res) => {
    ...
    try {
        ...
        await conn.execute(
            `INSERT IGNORE INTO scribe_unavailability (scribe_id, date, reason) 
             VALUES (?, ?, 'EXAM_BOOKED')`,
...
/**
 * Load Students (Requests) - 🟢 UPDATED FOR PAGINATION (Limit 5)
 */
export const loadStudents = async (req, res) => {
    ...
    try {
        ...
        // 🟢 FIX 1: Set limit to 5
        const limit = 5; 
        const pageNum = Number(page);
        const offset = (pageNum - 1) * limit;

        // 🟢 FIX 2: Fetch limit + 1 to detect next page
        ...
        // 🟢 FIX 3: Correct 'has_more' calculation
